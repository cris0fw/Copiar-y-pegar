    ...
    <footer className="bg-white">
      <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-main_verde sm:justify-start">
              <div className="relative object-contain w-[150px] h-[150px]">
                <Image sizes="150" src="/logo.png" fill alt="logo" />
              </div>
            </div>
            ...
            <ul className="flex justify-center gap-6 mt-8 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="transition text-main_verde hover:text-main_verde/75"
                >
